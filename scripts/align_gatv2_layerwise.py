#!/usr/bin/env python3
"""Layerwise numeric alignment check: Keras GATv2 vs kgcnn-torch GATv2."""
import os
import sys
...
def torch_forward_stages(model: GATv2Model, x, edge_attr, edge_index) -> Dict[str, torch.Tensor]:
    out: Dict[str, torch.Tensor] = {}
    h = model.dense_in(x)
...
def main():
    ...
    keras_stack = KerasGATv2Stack(cfg)
