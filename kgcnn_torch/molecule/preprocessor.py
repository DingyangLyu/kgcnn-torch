...
from kgcnn_torch.graph.base import GraphPreProcessorBase
from kgcnn_torch.molecule.methods import inverse_global_proton_dict
from kgcnn_torch.molecule.io import parse_list_to_xyz_str
from kgcnn_torch.molecule.encoder import OneHotEncoder
from kgcnn_torch.utils.serial import serialize
...
class SetMolAttributes(GraphPreProcessorBase):
    ...
    .. code-block:: python
        ...
        from kgcnn_torch.molecule.preprocessor import SetMolAttributes
        ds = QM7Dataset()
        pp = SetMolAttributes()
        print(pp(ds[0]))
