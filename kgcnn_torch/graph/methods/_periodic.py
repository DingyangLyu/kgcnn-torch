...
def range_neighbour_lattice(coordinates: np.ndarray, lattice: np.ndarray,
    ...
    .. code-block:: python
        ...
        import numpy as np
        from kgcnn_torch.graph.methods import range_neighbour_lattice
...
def range_neighbour_lattice_python_vectorized(
    ...
    .. code-block:: python
        ...
        import numpy as np
        from kgcnn_torch.graph.methods._periodic import range_neighbour_lattice_python_vectorized
