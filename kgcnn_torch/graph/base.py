...
from kgcnn_torch.graph.serial import get_preprocessor
...
class GraphProcessorBase:
    ...
    .. code-block:: python
        ...
        from kgcnn_torch.graph.base import GraphDict, GraphProcessorBase
...
class GraphPreProcessorBase(GraphProcessorBase):
    ...
    .. code-block:: python
        ...
        from kgcnn_torch.graph.base import GraphDict, GraphPreProcessorBase
...
class GraphPostProcessorBase(GraphProcessorBase):
    ...
    .. code-block:: python
        ...
        from kgcnn_torch.graph.base import GraphDict, GraphPostProcessorBase
